...
return [
    ...
    'dashboard' => [
        ...
        'arrived_month' => 'Ағымдағы айда келгендер',
        'treated_month' => 'Ағымдағы айда ем алғандар',
        'new_patients_month' => 'Ағымдағы айдағы жаңа пациенттер',
    ],
    ...
    'certificate' => [
        ...
        'status' => 'Анықтама',
        'issued' => 'Берілген',
        'not_issued' => 'Берілмеген',
        'period_from' => 'Қаралу басы',
        'period_to' => 'Қаралу соңы',
        'complaints' => 'Шағымдары',
        'examination' => 'Қарап-тексеру нәтижелері',
        'diagnosis' => 'Диагноз',
        'treatment' => 'Емдеу және ұсыныстар',
    ],
];
